const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Version 10', path: '/my-documents/preview-tasks/version-10' },
      { label: 'Version 11', path: '/my-documents/preview-tasks/version-11' },
      { label: 'Version 12', path: '/my-documents/preview-tasks/version-12' },
      { label: 'Version 13', path: '/my-documents/preview-tasks/version-13' },
    ],
  },
  {
